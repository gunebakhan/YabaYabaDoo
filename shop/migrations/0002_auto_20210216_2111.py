...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('shop', '0001_initial'),
        ('products', '0002_auto_20210216_2111'),
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='payment',
            name='order',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='payments', related_query_name='payments', to='shop.shoporder', verbose_name='ShopOrder'),
        ),
        migrations.AddField(
            model_name='payment',
            name='user',
        ...
        migrations.AddField(
            ...
            name='order',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='order_items', related_query_name='order_items', to='shop.shoporder', verbose_name='ShopOrder'),
        ),
        migrations.AddField(
            model_name='orderitem',
            name='shop_product',
